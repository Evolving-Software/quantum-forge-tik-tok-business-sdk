...
export class AdgroupcreateIncludedCustomActions {
   ...
   */
  static constructFromObject(data: any, obj?: AdgroupcreateIncludedCustomActions): AdgroupcreateIncludedCustomActions {
    if (data) {
      ...
      if (data.hasOwnProperty('days')) obj.days = ApiClient.convertToType(data['days'], 'Number');
    }
    return obj!;
  }
}
