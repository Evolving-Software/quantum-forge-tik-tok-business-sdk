...
export class AdcreateCreatives {
   ...
   */
  static constructFromObject(data: any, obj?: AdcreateCreatives): AdcreateCreatives {
    const result = obj || new AdcreateCreatives();
    ...
    if (data) {
      ...
      if (data.hasOwnProperty('shopping_ads_word_set'))
        result.shopping_ads_word_set = ApiClient.convertToType(data['shopping_ads_word_set'], ['Number']);
