...
/**
 * The AdcreateCreatives model.
 */
export class AdcreateCreatives implements ModelBase {
    'appId'?: string;
    'appName'?: string;
    ...
    /**
     * Returns an instance of AdcreateCreatives populated with the given data
     */
    constructFromObject(data: unknown): this {
        ...
        if (typedData['isAutoBind'] !== undefined) {
            this['isAutoBind'] = ApiClient.convertToType(typedData['isAutoBind'], 'String') as string;
        }
        ...
        if (typedData['repeatType'] !== undefined) {
            this['repeatType'] = ApiClient.convertToType(typedData['repeatType'], 'String') as string;
        }
     ...
     */
    static fromObject(data: unknown): AdcreateCreatives {
        const instance = new AdcreateCreatives();
     ...
     */
    static constructFromObject(data: unknown): AdcreateCreatives {
        return AdcreateCreatives.fromObject(data);
    }
}
