...
export class CreativeportfoliocreateStickerParam {
    ...
    cutoff_time?: number | undefined;
    /** @type {number | undefined} */
    display_angle?: number | undefined;
    /** @type {string | undefined} */
    landing_page_url?: string | undefined;
    /** @type {string | undefined} */
    live_tiktok_user_id?: string | undefined;
    /** @type {number | undefined} */
     ...
     */
    static constructFromObject(data: any, obj?: CreativeportfoliocreateStickerParam): CreativeportfoliocreateStickerParam {
        if (data) {
            ...
            if (data.hasOwnProperty('cutoff_time')) obj.cutoff_time = ApiClient.convertToType(data['cutoff_time'], 'Number');
            if (data.hasOwnProperty('display_angle')) obj.display_angle = ApiClient.convertToType(data['display_angle'], 'Number');
            if (data.hasOwnProperty('landing_page_url')) obj.landing_page_url = ApiClient.convertToType(data['landing_page_url'], 'String');
            if (data.hasOwnProperty('live_tiktok_user_id')) obj.live_tiktok_user_id = ApiClient.convertToType(data['live_tiktok_user_id'], 'String');
            if (data.hasOwnProperty('opacity')) obj.opacity = ApiClient.convertToType(data['opacity'], 'Number');
            ...
            if (data.hasOwnProperty('reminder_time')) obj.reminder_time = ApiClient.convertToType(data['reminder_time'], 'Number');
            if (data.hasOwnProperty('size')) obj.size = ApiClient.convertToType(data['size'], 'Number');
            if (data.hasOwnProperty('sticker_type')) obj.sticker_type = ApiClient.convertToType(data['sticker_type'], 'String');
