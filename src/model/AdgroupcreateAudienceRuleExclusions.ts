...
export class AdgroupcreateAudienceRuleExclusions {
    /** @type {string} */
    operator?: string;
    /** @type {Array.<AdgroupcreateAudienceRuleExclusionsRules>} */
     ...
     */
    static constructFromObject(data: any, obj?: AdgroupcreateAudienceRuleExclusions): AdgroupcreateAudienceRuleExclusions {
        if (data) {
            ...
            if (data.hasOwnProperty('rules')) obj.rules = ApiClient.convertToType(data['rules'], [AdgroupcreateAudienceRuleExclusionsRules]);
        }
        return obj!;
    }
}
