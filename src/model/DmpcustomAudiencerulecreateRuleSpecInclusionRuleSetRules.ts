...
import { DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet } from './DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet';
...
export class DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules {
  event_source_ids?: string[] | undefined;
  filter_set?: DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetFilterSet | undefined;
   ...
   * @class
   * @param retention_days {Number} The data retention period for events. Value range- 1-180. Unit is day.
   */
  constructor() {
    this.event_source_ids = undefined;
    this.filter_set = undefined;
    this.retention_days = undefined;
  }
   ...
   */
  static constructFromObject(data: any, obj?: DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules): DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules {
    if (data) {
    ...
    return obj || new DmpcustomAudiencerulecreateRuleSpecInclusionRuleSetRules();
  }
}
