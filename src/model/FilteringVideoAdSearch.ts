...
export class FilteringVideoAdSearch {
  ...
  /**
   * Video aspect ratio, e.g.: [1.7, 2.5]. Use 1.7 to search for videos with aspect ratio between 1.65-1.75
  ...
  /**
   * Constructs a <code>FilteringVideoAdSearch</code> from a plain JavaScript object
   * @param {Record<string, any>} data The plain JavaScript object bearing properties of interest
   * @param {FilteringVideoAdSearch} [obj] Optional instance to populate
   * @return {FilteringVideoAdSearch} The populated <code>FilteringVideoAdSearch</code> instance
   */
  static constructFromObject(data: Record<string, any>, obj?: FilteringVideoAdSearch): FilteringVideoAdSearch {
    if (!data) return obj || new FilteringVideoAdSearch();
