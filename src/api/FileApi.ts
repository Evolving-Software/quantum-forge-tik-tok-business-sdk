...
export class FileApi {
    ...
    */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    adVideoInfo(advertiser_id: string, video_ids: string[], Access_Token: string, callback?: (error: string | null, data?: InlineResponse200, response?: any) => void) {
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    fileImageAdInfo(advertiser_id: string, image_ids: string[], Access_Token: string, callback?: (error: string | null, data?: InlineResponse200, response?: any) => void) {
