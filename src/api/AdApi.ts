...
export class AdApi {
   ...
   */
  adCreate(Access_Token: string, opts: { body?: AdCreateBody } = {}, callback?: (error: string | null, data?: InlineResponse200, response?: string) => void) {
   ...
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  adStatusUpdate(Access_Token: string, opts: { body?: AdStatusUpdateBody } = {}, callback?: (error: string | null, data?: InlineResponse200, response?: string) => void) {
    const postBody = opts['body'];
    // verify the required parameter 'Access_Token' is set
    if (Access_Token === undefined || Access_Token === null) {
   ...
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  adUpdate(Access_Token: string, opts: { body?: AdUpdateBody } = {}, callback?: (error: string | null, data?: InlineResponse200, response?: string) => void) {
    const postBody = opts['body'];
    // verify the required parameter 'Access_Token' is set
    if (Access_Token === undefined || Access_Token === null) {
